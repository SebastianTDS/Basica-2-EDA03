...
public class PruebaEva03 {
	...
	// La excepcion adicional es para los tests adicionales más abajo,
	...
	@Test
	public void queUnTriatletaPuedaParticiparEnUnTriatlon() throws NoEstaPreparado, NoExisteElEventoSolicitado {
	...
	@Test
	public void queUnNadadorPuedaParticiparEnUnaCarreraDeNatacion() throws NoEstaPreparado, NoExisteElEventoSolicitado {
	...
	@Test
	public void queNoSeInscribanDosPersonasIgualesAlMismoEvento() throws NoEstaPreparado, NoExisteElEventoSolicitado {
		Deportista camila = new Nadador(1, "Camila", "Espalda");
		Club actual = new Club("Sitas");
	...
	@Test
	public void queUnTriatletaSePuedaAnotarEnTodosLosEventos() throws NoEstaPreparado, NoExisteElEventoSolicitado {
	...
	@Test (expected = NoExisteElEventoSolicitado.class)
	public void queTireExcepcionAlBuscarEventoInexistente() throws NoEstaPreparado, NoExisteElEventoSolicitado {
		Deportista camila = new Nadador(1, "Camila", "Espalda");
		Club actual = new Club("Sitas");
